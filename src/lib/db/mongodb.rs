...
pub async fn add_order(shipment: NewOrder)-> Result<(), anyhow::Error> {
    ...
    let new_shipment =  MongoShipments {
        ...
        LOADED_DTTM: None,
        CHECKOUT_DTTM: None,
        MA_SHIPMENT_ID: Some(shipment.MA_SHIPMENT_ID),
        ...
        DOCK_DOOR: Some(shipment.DOCK_DOOR),
        TRAILER_NUMBER: shipment.TRAILER_NUMBER,
        CHECK_IN_USER: Some(shipment.ACTIVITY_USER),
        CUSTOMER: shipment.CUSTOMER_NAME,
        CARRIER: Some(shipment.CARRIER),
        MA_APPOINTMENT_ID: Some(shipment.APPOINTMENT_ID),
        APPOINTMENT_DTTM: Option::from(shipment.PICKUP_START_DTTM.and_utc()),
        APPOINTMENT_ADHERENCE: Some(shipment.APPOINTMENT_ADHERENCE),
        APPOINTMENT_TIME_VARIANCE: Some(shipment.APPOINTMENT_TIME_VARIANCE),
        APPOINTMENT_STATUS: Some(shipment.APPOINTMENT_STATUS),
